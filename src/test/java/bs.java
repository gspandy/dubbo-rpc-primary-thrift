...
public class bs {
    ...
    public interface Iface {
        ...
        public rsp_t search(req_t request) throws org.apache.thrift.TException;

    }

    public interface AsyncIface {

        public void search(req_t request, org.apache.thrift.async.AsyncMethodCallback resultHandler)
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public void send_search(req_t request) throws org.apache.thrift.TException {
            search_args args = new search_args();
            args.setRequest(request);
            sendBase("search", args);
        }

        public rsp_t recv_search() throws org.apache.thrift.TException {
    ...
    public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
        ...
        public static class search_call extends org.apache.thrift.async.TAsyncMethodCall {
            ...
            private req_t request;

            public search_call(req_t request, org.apache.thrift.async.AsyncMethodCallback resultHandler,
            ...
            public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
                prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("search",
            ...
            public rsp_t getResult() throws org.apache.thrift.TException {
    ...
    public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
        ...
        public static class search<I extends AsyncIface> extends
                org.apache.thrift.AsyncProcessFunction<I, search_args, rsp_t> {
            ...
            @Override
            public AsyncMethodCallback<rsp_t> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
                final org.apache.thrift.AsyncProcessFunction fcall = this;
                return new AsyncMethodCallback<rsp_t>() {

                    @Override
                    public void onComplete(rsp_t o) {
                        search_result result = new search_result();
                        result.success = o;
                        try {
            ...
            @Override
            public void start(I iface, search_args args,
                    org.apache.thrift.async.AsyncMethodCallback<rsp_t> resultHandler) throws TException {
    ...
    public static class search_args implements org.apache.thrift.TBase<search_args, search_args._Fields>,
        ...
        static {
            ...
            tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request",
                    org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
                            org.apache.thrift.protocol.TType.STRUCT, req_t.class)));
        ...
        public search_args(req_t request) {
            this();
            this.request = request;
        }
        ...
        public search_args(search_args other) {
            if (other.isSetRequest()) {
                this.request = new req_t(other.request);
            }
        }
        ...
        public req_t getRequest() {
            return this.request;
        }

        public search_args setRequest(req_t request) {
            this.request = request;
            return this;
        }
        ...
        private static class search_argsStandardScheme extends StandardScheme<search_args> {
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol iprot, search_args struct)
                    throws org.apache.thrift.TException {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol oprot, search_args struct)
                    throws org.apache.thrift.TException {
                struct.validate();
        ...
        private static class search_argsTupleScheme extends TupleScheme<search_args> {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol prot, search_args struct)
                    throws org.apache.thrift.TException {
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol prot, search_args struct)
                    throws org.apache.thrift.TException {
    ...
    public static class search_result implements org.apache.thrift.TBase<search_result, search_result._Fields>,
        ...
        static {
            ...
            tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success",
                    org.apache.thrift.TFieldRequirementType.DEFAULT, new org.apache.thrift.meta_data.StructMetaData(
                            org.apache.thrift.protocol.TType.STRUCT, rsp_t.class)));
            metaDataMap = Collections.unmodifiableMap(tmpMap);
        ...
        public search_result(rsp_t success) {
            this();
        ...
        public search_result(search_result other) {
            if (other.isSetSuccess()) {
                this.success = new rsp_t(other.success);
            }
        }
        ...
        public rsp_t getSuccess() {
            return this.success;
        }

        public search_result setSuccess(rsp_t success) {
            this.success = success;
            return this;
        }
        ...
        private static class search_resultStandardScheme extends StandardScheme<search_result> {
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol iprot, search_result struct)
                    throws org.apache.thrift.TException {
                org.apache.thrift.protocol.TField schemeField;
                iprot.readStructBegin();
                while (true) {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol oprot, search_result struct)
                    throws org.apache.thrift.TException {
                struct.validate();
        ...
        private static class search_resultTupleScheme extends TupleScheme<search_result> {
            ...
            @Override
            public void write(org.apache.thrift.protocol.TProtocol prot, search_result struct)
                    throws org.apache.thrift.TException {
                TTupleProtocol oprot = (TTupleProtocol) prot;
                BitSet optionals = new BitSet();
            ...
            @Override
            public void read(org.apache.thrift.protocol.TProtocol prot, search_result struct)
                    throws org.apache.thrift.TException {
                TTupleProtocol iprot = (TTupleProtocol) prot;
                BitSet incoming = iprot.readBitSet(1);
                if (incoming.get(0)) {
